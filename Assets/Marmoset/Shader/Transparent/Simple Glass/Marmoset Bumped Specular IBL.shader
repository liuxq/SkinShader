...
Shader "Marmoset/Transparent/Simple Glass/Bumped Specular IBL" {
	Properties {
	...
	SubShader {
		...
		#pragma surface MarmosetSurf MarmosetDirect vertex:MarmosetVert alpha:premul
	...
	FallBack "Marmoset/Transparent/Bumped Specular IBL"
}
