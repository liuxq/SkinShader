...
Shader "Marmoset/Beta/Layered/ Masked 4-Layer IBL" {
	Properties {
		_LayerMask ("Layer Mask(RGBA)", 2D) = "red" {}
		_LayerMaskTiling ("Tiling(xy) Offset(zw)", Vector) = (1,1,0,0)
