Shader "Marmoset/Mobile/Terrain/Terrain Specular IBL" {
...
//mobile fallback
//no mip gloss, no detail normals
SubShader {
	Tags {
		"SplatCount" = "4"
		"Queue" = "Geometry-100"
...
//mobile fallback
//no mip gloss, no detail normals, no specular IBL
SubShader {
	Tags {
		"SplatCount" = "4"
		"Queue" = "Geometry-100"
...
Fallback "Marmoset/Mobile/Terrain/Terrain Diffuse IBL"
}
